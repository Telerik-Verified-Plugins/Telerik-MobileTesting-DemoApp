// TODO: change this to your own iOS Launch URL (the one you configured when installing this plugin)
var iOSUrlScheme = "teleriktestapp";

// TODO: change this to the Android package name (in AppBuilder see the 'Application Identifier' in the Properties section)
var androidPackageName = "com.telerik.plugindemo.telerikmobiletesting";

// TODO WP8 launch URL
var wp8launchUrl = "defaultApp";
...
spec(function(){
	...
	var stepRepository = {
		"launch demo application": {
			'ios': [
				ios.launch(iOSUrlScheme+'://')
			],
			'android': [
				android.launch(androidPackageName)
			],
			'wp8': [
				wp8.launch(wp8launchUrl),
			]
		},
